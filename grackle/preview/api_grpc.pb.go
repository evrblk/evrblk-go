...
const (
	...
	GracklePreviewApi_AddJobToWaitGroup_FullMethodName        = "/com.evrblk.grackle.preview.GracklePreviewApi/AddJobToWaitGroup"
	GracklePreviewApi_CompleteJobFromWaitGroup_FullMethodName = "/com.evrblk.grackle.preview.GracklePreviewApi/CompleteJobFromWaitGroup"
...
type GracklePreviewApiClient interface {
	...
	AddJobToWaitGroup(ctx context.Context, in *AddJobToWaitGroupRequest, opts ...grpc.CallOption) (*AddJobToWaitGroupResponse, error)
	CompleteJobFromWaitGroup(ctx context.Context, in *CompleteJobFromWaitGroupRequest, opts ...grpc.CallOption) (*CompleteJobFromWaitGroupResponse, error)
...
func (c *gracklePreviewApiClient) AddJobToWaitGroup(ctx context.Context, in *AddJobToWaitGroupRequest, opts ...grpc.CallOption) (*AddJobToWaitGroupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddJobToWaitGroupResponse)
	err := c.cc.Invoke(ctx, GracklePreviewApi_AddJobToWaitGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gracklePreviewApiClient) CompleteJobFromWaitGroup(ctx context.Context, in *CompleteJobFromWaitGroupRequest, opts ...grpc.CallOption) (*CompleteJobFromWaitGroupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompleteJobFromWaitGroupResponse)
	err := c.cc.Invoke(ctx, GracklePreviewApi_CompleteJobFromWaitGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GracklePreviewApiServer interface {
	...
	AddJobToWaitGroup(context.Context, *AddJobToWaitGroupRequest) (*AddJobToWaitGroupResponse, error)
	CompleteJobFromWaitGroup(context.Context, *CompleteJobFromWaitGroupRequest) (*CompleteJobFromWaitGroupResponse, error)
...
func (UnimplementedGracklePreviewApiServer) AddJobToWaitGroup(context.Context, *AddJobToWaitGroupRequest) (*AddJobToWaitGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddJobToWaitGroup not implemented")
}
func (UnimplementedGracklePreviewApiServer) CompleteJobFromWaitGroup(context.Context, *CompleteJobFromWaitGroupRequest) (*CompleteJobFromWaitGroupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CompleteJobFromWaitGroup not implemented")
}
...
func _GracklePreviewApi_AddJobToWaitGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddJobToWaitGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GracklePreviewApiServer).AddJobToWaitGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GracklePreviewApi_AddJobToWaitGroup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GracklePreviewApiServer).AddJobToWaitGroup(ctx, req.(*AddJobToWaitGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GracklePreviewApi_CompleteJobFromWaitGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompleteJobFromWaitGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GracklePreviewApiServer).CompleteJobFromWaitGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GracklePreviewApi_CompleteJobFromWaitGroup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GracklePreviewApiServer).CompleteJobFromWaitGroup(ctx, req.(*CompleteJobFromWaitGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GracklePreviewApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddJobToWaitGroup",
			Handler:    _GracklePreviewApi_AddJobToWaitGroup_Handler,
		},
		{
			MethodName: "CompleteJobFromWaitGroup",
			Handler:    _GracklePreviewApi_CompleteJobFromWaitGroup_Handler,
		},
		{
