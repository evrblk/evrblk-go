...
// client and server in the process, not just for this SDK's own connections.
...
//
// The fallback is what makes global registration safe. This SDK is embedded in
// applications that serve and call their own gRPC services, and those messages are
// generated without vtprotobuf helpers. A codec that errored on them would silently
// break every other gRPC client and server in the importing process, including
